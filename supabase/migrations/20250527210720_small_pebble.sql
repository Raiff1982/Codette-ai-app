/*
  ...
  1. Changes
    ...
    - Sets up comprehensive file access policies
    
  2. Security
    - Allows all authenticated users to read files
    - Restricts file management (upload/delete) to admin users only
    - Uses user_roles table for role verification
    
  3. Policies
    - Storage bucket: codette-files
    - Read access: All authenticated users
    - Write/Delete access: Admin users only
*/
